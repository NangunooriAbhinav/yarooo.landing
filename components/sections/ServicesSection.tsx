        ...
        <div className="-mx-4 mb-10 flex flex-wrap items-center lg:mb-[60px]">
          <div className="w-full px-4 lg:w-6/12">
            <div className="mb-[60px] max-w-[500px] xl:mb-[70px]">
              ...
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white sm:text-4xl md:text-[40px]">
                Designed to Enhance Your Affiliate Experience
              </h2>
            </div>
            <div className="-mx-4 flex flex-wrap">
              <div className="w-full px-4 sm:w-1/2">
                <div className="mb-10">
                  ...
                  <h3 className="mb-3 text-xl font-semibold text-gray-900 dark:text-white 2xl:text-[22px]">
                    Effortless Link Management
                  </h3>
                  <p className="text-base leading-relaxed text-gray-600 dark:text-gray-400">
                    Browse, manage, and share affiliate links with ease, all from one central dashboard.
                  </p>
                </div>
              </div>
              <div className="w-full px-4 sm:w-1/2">
                <div className="mb-10">
                  ...
                  <p className="text-base leading-relaxed text-gray-600 dark:text-gray-400">
                    Track your cashback earnings and get detailed performance insights to optimize your strategy.
                  </p>
                </div>
              </div>
              <div className="w-full px-4 sm:w-1/2">
                <div className="mb-10">
                  ...
                  <p className="text-base leading-relaxed text-gray-600 dark:text-gray-400">
                    Enjoy hassle-free transactions and cashback payouts with our seamless payment system.
                  </p>
                </div>
              </div>
              <div className="w-full px-4 sm:w-1/2">
                <div className="mb-10">
                  ...
                  <p className="text-base leading-relaxed text-gray-600 dark:text-gray-400">
                    Access essential functionalities even without an internet connection, ensuring productivity anywhere.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="w-full px-4 lg:w-6/12">
            <div className="flex justify-center">
              <Iphone15Pro
                className=" w-[52%] h-[90%] mx-auto"
                src="/second-phone.png"
              />
            </div>
          </div>
        </div>
