...
export default function HeroSection() {
  return (
    <div className="relative z-10 overflow-hidden bg-white pb-16 pt-[120px] dark:bg-gray-900 md:pb-[110px] md:pt-[150px]">
      <div className="absolute left-0 top-0 z-[-1] h-full w-full md:rounded-br-[200px] bg-gray-100 dark:bg-gray-800 lg:w-1/2"></div>
          ...
          <div className="w-full px-4 lg:w-5/12">
            <div className="hero-content">
              <span className="mb-4 block text-lg font-medium text-blue-600">
                The Smart Way to Shop & Share
              </span>
              <h1 className="mb-4 text-3xl font-bold !leading-[1.208] text-gray-900 dark:text-white sm:text-4xl lg:text-[40px] xl:text-5xl">
                Earn More, Spend Less 
              </h1>
              <p className="mb-8 md:mb-16 max-w-[440px] text-base text-gray-600 dark:text-gray-400">
                Join our platform and get cashbacks on affiliate purchases while managing everything seamlessly via our app and website.
              </p>
          ...
          <div className="w-full px-4 lg:w-1/2">
            <div className="mx-auto text-center">
              <div className="relative z-10 mt-16 inline-block lg:mt-0">
                <Iphone15Pro
                  className="mx-auto w-[65%] md:w-[75%] sm:h-[0%] h-[5%] "
                  src="/hero-phone.png"
                />
                <div className="absolute -left-6 -top-6 z-[-1] md:-left-10 md:-top-10">
                  <svg
                    width="30"
                    height="30"
                    viewBox="0 0 40 38"
                ...
                <div className="absolute -left-10 top-1/2 z-[-1] hidden md:block">
                  <svg
                    width="40"
                    height="38"
                    viewBox="0 0 40 38"
                ...
                <div className="absolute -right-8 bottom-8 z-[-1] md:-right-16 md:bottom-10">
                  <svg
                    width="40"
                    height="40"
                    viewBox="0 0 53 53"
